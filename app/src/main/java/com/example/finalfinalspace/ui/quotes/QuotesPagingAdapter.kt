...
class QuotesPagingAdapter @Inject constructor() :
    PagingDataAdapter<QuoteOrCharacter, RecyclerView.ViewHolder>(QuoteOrCharacterDiffCallback()) {

    companion object {
        internal const val TYPE_CHARACTER = 10
        internal const val TYPE_QUOTE = 20
    }
